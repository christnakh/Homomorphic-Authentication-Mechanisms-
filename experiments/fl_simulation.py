...
def main():
    ...
    parser.add_argument("--use_he", action="store_true",
                       help="Use homomorphic encryption")
    ...
    for i in range(args.clients):
        client = FLClient(client_id=i, model_dim=args.model_dim, 
                         auth_scheme=args.auth_scheme, use_encryption=args.use_he)
    ...
    import json
    with open(os.path.join(args.output, "fl_simulation_metrics.json"), 'w') as f:
        json.dump({
